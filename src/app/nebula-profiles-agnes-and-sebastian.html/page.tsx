...
export default function AgnesSebastianPage() {
  return (
      ...
      <main className="flex-grow w-full max-w-[1200px] mx-auto px-4 md:px-8 pt-36 pb-20 md:pt-44 md:pb-24">
        <div className="text-left space-y-12">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tighter uppercase leading-none text-foreground">AGNES FISCHER &amp; SEBASTIAN SIMONS</h1>
            <div className="w-12 h-1 bg-[#FF8500]"></div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pt-4 items-start text-left">
            <div className="md:col-span-8 space-y-4 text-xs font-semibold leading-relaxed tracking-wide text-foreground/75">

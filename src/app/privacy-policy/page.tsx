...
export const metadata: Metadata = {
  title: "NEBULA | Privacy Policy & Data Security",
  description: "Learn how NEBULA processes and secures customer data under European GDPR regulations and Danish privacy standards.",
};
      ...
      <main className="flex-grow w-full max-w-[1200px] mx-auto px-4 md:px-8 pt-36 pb-20 md:pt-44 md:pb-24">
        <div className="text-left space-y-12 max-w-[800px]">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl font-black tracking-tighter uppercase leading-none">PRIVACY POLICY</h1>
